...
IMAGENET_TEMPLATES_SMALL = [
    ...
    "Candid snapshot of {}",
    "Formal portrait of {}",
    "Vintage 80s photo of {}",
    "Relaxed outdoor photo of {}",
    "Close-up shot of {}",
    "Action-packed presentation photo of {}",
    "Behind-the-scenes photo of {}",
    "Artistic silhouette photo of {}",
    "Panoramic event photo of {}",
    "High-angle shot of {}",
    "Low-light ambient photo of {}",
    "High-resolution photo of {}",
    "Monochromatic photo of {}",
    "Soft-lit studio photo of {}",
    "Profile-view photo of {}",
    "Detailed close-up photo of {}",
    "Wide-angle photo of {}",
    "Neutral background photo of {}",
    "Natural light photo of {}",
    "Sharp-focus photo of {}",
    "Minimalist photo of {}",
    "Over-the-shoulder photo of {}",
    "Blurred background photo of {}",
    "High-contrast photo of {}",
    "Low-key lighting photo of {}",
    "Mid-shot photo of {}"
]
